package edu.aku.hassannaqvi.tpvics_hhlisting_app.core;
...
import edu.aku.hassannaqvi.tpvics_hhlisting_app.contracts.SignupContract.SignUpTable;
import edu.aku.hassannaqvi.tpvics_hhlisting_app.contracts.TeamsContract;
import edu.aku.hassannaqvi.tpvics_hhlisting_app.contracts.TeamsContract.SingleTaluka;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_PASSWORD = "asSa%s|n'$ crEed";
...
// Which row to update, based on the title
    ...
    public JSONArray getUnsyncedListing() {
        SQLiteDatabase db = this.getReadableDatabase(DATABASE_PASSWORD);
        Cursor c = null;
        String[] columns = null;
        ...
        try {
            ...
            while (c.moveToNext()) {
                ListingContract listing = new ListingContract();
                allLC.put(listing.hydrate(c, 0).toJSONObject());
            }
        } catch (JSONException e) {
            e.printStackTrace();
        } finally {
